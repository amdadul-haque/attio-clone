    ...
    >
      <div class="flex items-center">
        <div class="">
          ...
          <div class="mt-8 flex gap-3 flex-col md:flex-row">
            <button
              class="bg-[#8fb7ff] hover:bg-white-main border text-white-main hover:text-blue-500 text-[16px] font-semibold px-4 py-3 rounded-xl transition-all"
            >
              Try for free
            </button>
            <button
              class="bg-transparent text-white-main text-[16px] font-semibold px-4 py-3 rounded-xl border border-[#ccc] hover:border-white-main transition-all"
            >
              Talk to sales
            </button>
          </div>
